...
clean_data = BashOperator(
    ...
    bash_command=f'spark-submit --master yarn --deploy-mode cluster --class esgi.circulation.Clean hdfs:///jars/grp5/Circulation.jar  hdfs:///data/grp5/raw/data-{YEAR}-{MONTH}-{DAY}.csv hdfs:///data/grp5/cleaned',
    dag=dag
)
...
transform_data = BashOperator(
    ...
    # TODO : compléter le spark submit
    bash_command=f"spark-submit --master yarn --deploy-mode cluster --class esgi.circulation.Jointure  hdfs:///jars/grp5/Circulation.jar  hdfs:///data/grp5/cleaned/data-{YEAR}-{MONTH}-{DAY}.csv hdfs:///data/grp5/joined",
    dag=dag
)
